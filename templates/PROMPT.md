...
2. Read docs/specs/PRD.json — pick the single best failing item (unblock downstream first)
...
6. If green: update docs/specs/PRD.json (passes: true), append to .claude/PROGRESS.md, commit, STOP
7. If stuck after 3 attempts: append failure notes to .claude/PROGRESS.md, commit, STOP
