...
6. If green: update docs/specs/PRD.json (passes: true), append to docs/PROGRESS.md, commit, STOP
7. If stuck after 3 attempts: append failure notes to docs/PROGRESS.md, commit, STOP
